...
public class BuildBodyWithId extends Task {
    private static final String JSON_TEMPLATE = "{\"count\":%d, \"sinkIndexTime\":%d}";
    ...
    public BuildBodyWithId(TaskContext taskContext, UserConfig userConf) {
    ...
    public void onNext(Message message) {
        ...
        if (payload instanceof Tuple2) {
            ...
            // prepare doc body
            String body = String.format(JSON_TEMPLATE, count, now());
